...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[FUN_lw] = LAYOUT(
		 ...
		 KC_LGUI, KC_LALT, KC_LCTL, KC_LSFT, KC_CAPS, KC_NO,   KC_NO, KC_PSCR, KC_F4, KC_F5, KC_F6, KC_F11,
		 KC_NO,   KC_PSCR, KC_SCRL, KC_BRK,  KC_INS,  KC_NO,   KC_NO, KC_NO,   KC_F1, KC_F2, KC_F3, KC_F12,
		                   KC_RCTL, KC_APP,  KC_NO,                   MO(FW),  KC_NO, KC_NO
	),
	[FUN_m] = LAYOUT(
		 KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,                   KC_F6,   KC_F7, KC_F8, KC_F9, KC_F10,
		 KC_LCTL, KC_LALT, KC_LGUI, KC_LSFT, KC_CAPS, KC_NO,   KC_NO, KC_PSCR, KC_F4, KC_F5, KC_F6, KC_F11,
		 KC_NO,   KC_PSCR, KC_SCRL, KC_BRK,  KC_INS,  KC_NO,   KC_NO, KC_NO,   KC_F1, KC_F2, KC_F3, KC_F12,
		                   KC_RCTL, KC_APP,  KC_NO,                   MO(FW),  KC_NO, KC_NO
	),
	/* Navigation (`NAV`)
