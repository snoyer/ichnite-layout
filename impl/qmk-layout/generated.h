...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[BASE_l] = LAYOUT(
		 ...
		 KC_Z,         KC_X,         KC_C,           KC_D,              KC_V,           KC_CLCK,  KC_EQL,  KC_K,           KC_H,            KC_COMM,        KC_DOT,       KC_SLSH,
	...
	[SYM] = LAYOUT(
		 ...
		 KC_HASH, KC_DLR,  KC_AT,   KC_LPRN, KC_RPRN, KC_NO,  KC_NO, KC_NO,  KC_LSFT, KC_LCTL, KC_LALT, KC_LGUI,
	...
	[NUM] = LAYOUT(
		 ...
		 KC_LGUI, KC_LALT, KC_LCTL, KC_LSFT, KC_NO,   KC_NO,  KC_PPLS, KC_PMNS, KC_4,   KC_5,   KC_6, KC_PDOT,
		 KC_PAST, KC_NO,   KC_PERC, KC_LT,   KC_GT,   KC_NO,  KC_PAST, KC_0,    KC_1,   KC_2,   KC_3, KC_PSLS,
	...
	[FUN] = LAYOUT(
		 ...
		 KC_LGUI, KC_LALT, KC_LCTL, KC_LSFT, KC_CLCK, KC_NO,  KC_NO, KC_PSCR, KC_F4, KC_F5, KC_F6, KC_F11,
		 KC_NO,   KC_PSCR, KC_SLCK, KC_BRK,  KC_INS,  KC_NO,  KC_NO, KC_NO,   KC_F1, KC_F2, KC_F3, KC_F12,
	...
	[NAV_m] = LAYOUT(
		 ...
		 LGUI(KC_G),       KC_LEFT, KC_DOWN, KC_RGHT, LGUI(KC_C), LGUI(KC_Z),  LGUI(KC_SLSH), KC_NO,      KC_LSFT,           KC_LCTL, KC_LALT, KC_LGUI,
	...
	[SYS] = LAYOUT(
		 ...
		 KC_BRID, KC_MSTP, KC_VOLD, KC_MPLY, KC_WHOM, KC_F15,  KC_F17, KC_NO, KC_LSFT, KC_LCTL, KC_LALT, KC_LGUI,
	...
	[UTF] = LAYOUT(
		 ...
		 UC(0x00d7), KC_NO,      UC(0x2248), UC(0x2264), UC(0x2265), KC_NO,  KC_NO, UC(0x03bb), UC(0x03b1), UC(0x03b2), UC(0x00bf), UC(0x00f7),
	...
	[FW] = LAYOUT(
		 ...
		 KC_NO, TO(BASE_w), TO(BASE_m), TO(BASE_l), KC_NO, KC_NO,  KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
		 KC_NO, KC_NO,      KC_NO,      KC_NO,      KC_NO, KC_NO,  KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
